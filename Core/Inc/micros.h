...
{
	CoreDebug->DEMCR |= CoreDebug_DEMCR_TRCENA_Msk; // разрешаем использовать счётчик -- Google Translated "We allow the use of the meter"
	DWT->CTRL |= DWT_CTRL_CYCCNTENA_Msk;   // запускаем счётчик -- Google Translated "Launch the counter"
}
