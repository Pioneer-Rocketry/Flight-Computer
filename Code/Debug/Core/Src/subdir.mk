...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/Subsystem.cyclo ./Core/Src/Subsystem.d ./Core/Src/Subsystem.o ./Core/Src/Subsystem.su ./Core/Src/board_api.cyclo ./Core/Src/board_api.d ./Core/Src/board_api.o ./Core/Src/board_api.su ./Core/Src/dfuBootloader.cyclo ./Core/Src/dfuBootloader.d ./Core/Src/dfuBootloader.o ./Core/Src/dfuBootloader.su ./Core/Src/main.cyclo ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/main.su ./Core/Src/stm32f4xx_hal_msp.cyclo ./Core/Src/stm32f4xx_hal_msp.d ./Core/Src/stm32f4xx_hal_msp.o ./Core/Src/stm32f4xx_hal_msp.su ./Core/Src/stm32f4xx_it.cyclo ./Core/Src/stm32f4xx_it.d ./Core/Src/stm32f4xx_it.o ./Core/Src/stm32f4xx_it.su ./Core/Src/syscalls.cyclo ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/syscalls.su ./Core/Src/sysmem.cyclo ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/system_stm32f4xx.cyclo ./Core/Src/system_stm32f4xx.d ./Core/Src/system_stm32f4xx.o ./Core/Src/system_stm32f4xx.su ./Core/Src/utils.cyclo ./Core/Src/utils.d ./Core/Src/utils.o ./Core/Src/utils.su ./Core/Src/usbHelper.cyclo ./Core/Src/usbHelper.d ./Core/Src/usbHelper.o ./Core/Src/usbHelper.su ./Core/Src/usb_descriptors.cyclo ./Core/Src/usb_descriptors.d ./Core/Src/usb_descriptors.o ./Core/Src/usb_descriptors.su
