...
#define W25Q128JV_SR_WRITE_ENABLE 					0x50
...
#define W25Q128JV_CHIP_ERASE_1 						0xC7
#define W25Q128JV_CHIP_ERASE_2 						0x60
#define W25Q128JV_READ_STATUS_REG_1 				0x05
#define W25Q128JV_READ_STATUS_REG_2					0x35
#define W25Q128JV_READ_STATUS_REG_3 				0x15
#define W25Q128JV_WRITE_STATUS_REG_1 				0x01
#define W25Q128JV_WRITE_STATUS_REG_2				0x31
#define W25Q128JV_WRITE_STATUS_REG_3 				0x11
...
#define W25Q128JV_REG_1_STATUS_REGISTER_PROTECT 	0x80
#define W25Q128JV_REG_1_SECTOR_PROTECT 				0x40
#define W25Q128JV_REG_1_TOP_BOTTOM_PROTECT 			0x20
#define W25Q128JV_REG_1_BLOCK_PROTECT_BITS 			0x1C
#define W25Q128JV_REG_1_WRITE_ENABLE_LATCH 			0x02
#define W25Q128JV_REG_1_WRITE_IN_PROGRESS 			0x01
#define W25Q128JV_REG_2_SUSPEND_STATUS 				0x80
#define W25Q128JV_REG_2_COMPLEMENT_PROTECT 			0x40
#define W25Q128JV_REG_2_SECURITY_REGISTER_LOCK_BITS	0x38
#define W25Q128JV_REG_2_RESERVED 					0x04
#define W25Q128JV_REG_2_QUAD_ENABLE 				0x02
#define W25Q128JV_REG_2_STATUS_REGISTER_LOCK 		0x01
#define W25Q128JV_REG_3_N_HOLD_OR_N_RESET 			0x80
#define W25Q128JV_REG_3_OUTPUT_DRIVER_STRENGTH 		0x40
#define W25Q128JV_REG_3_RESERVED_1 					0x18
#define W25Q128JV_REG_3_WRITE_PROTECT_SELECTION 	0x04
#define W25Q128JV_REG_3_RESERVED_2 					0x03

#define W25Q128JV_PAGE_SIZE 	256
#define W25Q128JV_SECTOR_SIZE 	4096
#define W25Q128JV_PAGE_COUNT 	65536
#define W25Q128JV_CAPACITY_BYTE (16 * 1024 * 1024) // 128 M-bit
#define W25Q128JV_CAPACITY_BIT  W25Q128JV_CAPACITY_BYTE*8
#define W25Q128JV_NUMBER_OF_SECTORS (W25Q128JV_CAPACITY_BYTE / W25Q128JV_SECTOR_SIZE)
...
public:
	...
	/**
	 * @brief Waits for the write in progress bit to clear, indicating that a write or erase operation has completed.
	 */
	void waitForWrite();
